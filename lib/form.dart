...
class MyForm extends State<RForm> {
  ...
  final TextEditingController nae = TextEditingController();
  ...
  Widget build(BuildContext context) {
    int s=0;
    return Scaffold(
      appBar: AppBar(title: Text(AppLocalizations.of(context)?.findbus ?? 'Find a Bus'),),
      body: Container(
            ...
            child: Column(
              ...
              TextFormField(
                ...
                decoration:  InputDecoration(
                  ...
                  hintText: (AppLocalizations.of(context)?.busno ?? 'Enter bus Number').toString(),
                ),
              ),
  ...
  void filterBusList() {
    final enteredText = name.text.toLowerCase();
    setState(() {
      filteredBusList = busList.where((bus) => bus.toLowerCase().contains(enteredText)).toList();
    });
  }
}
